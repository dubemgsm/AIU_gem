...
const DEFAULT_USERS = [
  { id: 1, username: 'admin', password: 'admin123', name: 'Admin President', role: 'super_admin', assigned_branch: 'global' },
  { id: 2, username: 'lagos_admin', password: 'lagos123', name: 'Nze Bartholomew Chijioke', role: 'branch_admin', assigned_branch: 'lagos' },
  { id: 3, username: 'abuja_admin', password: 'abuja123', name: 'Engr. Fidelis Anayo', role: 'branch_admin', assigned_branch: 'abuja' },
  { id: 4, username: 'ph_admin', password: 'ph123', name: 'Chief Ichie Jude Ezenwa', role: 'branch_admin', assigned_branch: 'portharcourt' },
  { id: 5, username: 'lagos_member', password: 'member123', name: 'Chinedu Okeke', role: 'member', assigned_branch: 'lagos' }
];
